...
.ExpensesApprovals
image::src/main/resources/com/anadoluefes/hr/expenses/ExpensesApproval-svg.svg[800,800]

.DepartmentLimitsValidations
image::src/main/resources/com/anadoluefes/DepartmentLimitsValidations-svg.svg[800,800]

.Notifications
image::src/main/resources/com/anadoluefes/Notifications-svg.svg[800,800]
